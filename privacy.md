...
That is the whole policy, but the App Store requires it spelled out, and a
one-line answer to a serious question deserves the detail behind it.

## What the app stores, and where

Your poems, the corrections you make to how a word scans, and anything you add
to the reading, websites and listening lists are kept in a database inside the
app's own container on your device.
...
Bàrdachd has no accounts, no messaging, no user-generated content visible to
anyone else, and no purchases. It collects nothing from anyone of any age.
